            ...
            <div class="col-md-6 col-md-offset-3">
                <form enctype="multipart/form-data" method="post" action="{{route('post.invoice.new')}}">
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="select_type" id="select_type" class="form-control prc">
                            <option value="">Select Type</option>
                            <option value="ring" id="ring">ring</option>
                            <option value="ring0" id="ring0">ring0</option>
                            <option value="ring1" id="ring1">ring1</option>
                            <option value="ring2" id="ring2">ring2</option>
                        </select>
                    </div>
                    <div class="ring" hidden>
                        <div class="col-md-12" style="margin-top: 15px;">
                            <a style="background: #1e282c;color: white;" class="btn" id="hide9">hide9</a>
                        </div>
                    <div class="col-md-4" style="margin-top: 15px;">
                        <div class="form-group has-feedback @if($errors->has('quantity')) has-error @endif">
                            <label for="quantity" class="control-label">Quantity</label>
                            <input type="text" name="quantity" id="quantity" class="form-control prc">
                            <span class="glyphicon glyphicon-credit-card form-control-feedback"></span>
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback @if($errors->has('ywaw')) has-error @endif">
                            ...
                            <input type="text" name="ywaw" id="ywaw" class="form-control">
                            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    ...
                    <div class="ring0" hidden>
                        <div class="col-md-12" style="margin-top: 15px;">
                            <a style="background: #1e282c;color: white;" class="btn" id="hide0">hide0</a>
                        </div>
                        <div class="col-md-4" style="margin-top: 15px;">
                            <div class="form-group has-feedback @if($errors->has('quantity')) has-error @endif">
                                <label for="quantity" class="control-label">Quantity</label>
                    ...
                    <div class="ring1" hidden>
                        <div class="col-md-12" style="margin-top: 15px;">
                            <a style="background: #1e282c;color: white;" class="btn" id="hide1">hide1</a>
                        </div>
                        <div class="col-md-4" style="margin-top: 15px;">
                            <div class="form-group has-feedback @if($errors->has('quantity')) has-error @endif">
                                <label for="quantity" class="control-label">Quantity</label>
                    ...
                    <div class="ring2" hidden>
                        <div class="col-md-12" style="margin-top: 15px;">
                            <a style="background: #1e282c;color: white;" class="btn" id="hide2">hide2</a>
                        </div>
                        <div class="col-md-4" style="margin-top: 15px;">
                            <div class="form-group has-feedback @if($errors->has('quantity')) has-error @endif">
                                <label for="quantity" class="control-label">Quantity</label>
